var query = "PREFIX%20rdf%3A%20%3Chttp%3A%2F%2Fwww.w3.org%2F1999%2F02%2F22-rdf-syntax-ns%23%3E%0APREFIX%20rdfs%3A%20%3Chttp%3A%2F%2Fwww.w3.org%2F2000%2F01%2Frdf-schema%23%3E%0APREFIX%20td%3A%20%3Chttps%3A%2F%2Fwww.w3.org%2F2019%2Fwot%2Ftd%23%3E%0APREFIX%20facility%3A%20%3Chttps%3A%2F%2Fcogito.iot.linkeddata.es%2Fdef%2Ffacility%23%3E%0APREFIX%20process%3A%20%3Chttps%3A%2F%2Fcogito.iot.linkeddata.es%2Fdef%2Fprocess%23%3E%0APREFIX%20qual%3A%20%3Chttps%3A%2F%2Fcogito.iot.linkeddata.es%2Fdef%2Fquality%23%3E%0APREFIX%20platform%3A%20%3Chttps%3A%2F%2Fcogito.iot.linkeddata.es%2Fdef%2Fplatform%23%3E%0APREFIX%20props%3A%20%3Chttps%3A%2F%2Fw3id.org%2Fprops%23%3E%0APREFIX%20hctl%3A%20%3Chttps%3A%2F%2Fwww.w3.org%2F2019%2Fwot%2Fhypermedia%23%3E%0ASELECT%20%3Ftd%20%3Ftitle%20%3Fdescription%20%3FiriHref%20(group_concat(%3Frelation%3Bseparator%3D%27%2C%20%27)%20as%20%3Frelations)%20WHERE%20%7B%0A%20%20%20%20%3Chttps%3A%2F%2Fdata.cogito.iot.linkeddata.es%2Ftdd%2Fapi%2Fthings%2Fb3fe643d-f9f2-4e14-bf3c-95343d63c850%3E%20a%20facility%3AProject%20.%0A%20%20%20%20BIND(%3Chttps%3A%2F%2Fdata.cogito.iot.linkeddata.es%2Ftdd%2Fapi%2Fthings%2Fb3fe643d-f9f2-4e14-bf3c-95343d63c850%3E%20AS%20%3Ftd)%0A%20%20%20%20%3Ftd%20td%3Atitle%20%3Ftitle%20.%0A%20%20%20%20%3Ftd%20td%3Adescription%20%3Fdescription%20.%0A%20%20%20%20%3Ftd%20td%3AhasPropertyAffordance%20%3Fproperty%20.%0A%20%20%20%20%3Fproperty%20td%3Aname%20%22platform%3AhasIRI%22%20.%0A%20%20%20%20%3Fproperty%20td%3AhasForm%20%3Fform%20.%0A%20%20%20%20%3Fform%20hctl%3AhasTarget%20%3FiriHref%20.%0A%20%20%20%20%3Ftd%20td%3AhasLink%20%3Flink%20.%0A%20%20%20%20%3Flink%20hctl%3AhasTarget%20%3Ftarget%20.%0A%20%20%20%20BIND(URI(%3Ftarget)%20AS%20%3FinfoResTD)%20.%0A%20%20%20%20%3FinfoResTD%20a%20qual%3AInformationResource%20.%0A%20%20%20%20%3FinfoResTD%20td%3AhasPropertyAffordance%20%3FirProperty%20.%0A%20%20%20%20%3FirProperty%20td%3Aname%20%22platform%3AhasFileURL%22%20.%0A%20%20%20%20%3FirProperty%20td%3AhasForm%20%3FirForm%20.%0A%20%20%20%20%3FirForm%20hctl%3AhintsAtMediaType%20%3FmediaType%20.%0A%20%20%20%20%3FirForm%20hctl%3AhasTarget%20%3FfileURL%20.%0A%20%20%20%20BIND(CONCAT(%3FmediaType%2C%27%20-%20%27%2CSTR(%3FfileURL))%20AS%20%3Frelation)%20.%0A%7D%20GROUP%20BY%20%3Ftd%20%3Ftitle%20%3Fdescription%20%3FiriHref%0A";

var url = "https://data.cogito.iot.linkeddata.es/tdd/api/search/sparql?query=" + query;
var events = [];
var head = null;
var results = null;
var td_count = 0;
...
var elements_query = "PREFIX%20rdf%3A%20%3Chttp%3A%2F%2Fwww.w3.org%2F1999%2F02%2F22-rdf-syntax-ns%23%3E%0APREFIX%20rdfs%3A%20%3Chttp%3A%2F%2Fwww.w3.org%2F2000%2F01%2Frdf-schema%23%3E%0APREFIX%20td%3A%20%3Chttps%3A%2F%2Fwww.w3.org%2F2019%2Fwot%2Ftd%23%3E%0APREFIX%20facility%3A%20%3Chttps%3A%2F%2Fcogito.iot.linkeddata.es%2Fdef%2Ffacility%23%3E%0APREFIX%20process%3A%20%3Chttps%3A%2F%2Fcogito.iot.linkeddata.es%2Fdef%2Fprocess%23%3E%0APREFIX%20qual%3A%20%3Chttps%3A%2F%2Fcogito.iot.linkeddata.es%2Fdef%2Fquality%23%3E%0APREFIX%20platform%3A%20%3Chttps%3A%2F%2Fcogito.iot.linkeddata.es%2Fdef%2Fplatform%23%3E%0APREFIX%20props%3A%20%3Chttps%3A%2F%2Fw3id.org%2Fprops%23%3E%0APREFIX%20hctl%3A%20%3Chttps%3A%2F%2Fwww.w3.org%2F2019%2Fwot%2Fhypermedia%23%3E%0ASELECT%20%3Ftd%20%3Ftitle%20%3Fdescription%20%3Ftarget%20%3FrelatedTD%20%3FiriHref%20(group_concat(%3Ffile%3B%20separator%3D%27%2C%20%27)%20as%20%3Ffiles)%20WHERE%20%7B%0A%20%20%20%20%3Ftd%20a%20facility%3AElement%20.%0A%20%20%20%20%3Ftd%20td%3Atitle%20%3Ftitle%20.%0A%20%20%20%20%3Ftd%20td%3Adescription%20%3Fdescription%20.%0A%20%20%20%20%3Ftd%20td%3AhasPropertyAffordance%20%3Fproperty%20.%0A%20%20%20%20%3Ftd%20td%3AhasPropertyAffordance%20%3Fproperty2%20.%0A%20%20%20%20%3Fproperty%20td%3Aname%20%27platform%3AhasIRI%27%20.%0A%20%20%20%20%3Fproperty%20td%3AhasForm%20%3Fform%20.%0A%20%20%20%20%3Fform%20hctl%3AhasTarget%20%3Ftarget%20.%0A%20%20%20%20%3Fproperty2%20td%3Aname%20%27platform%3AhasFileURL%27%20.%0A%20%20%20%20%3Fproperty2%20td%3AhasForm%20%3Fform2%20.%0A%20%20%20%20%3Fform2%20hctl%3AhasTarget%20%3Ftarget2%20.%0A%20%20%20%20%3Fform2%20hctl%3AhintsAtMediaType%20%3Ftype%20.%0A%20%20%20%20%3Ftd%20td%3AhasLink%20%3Flink%20.%0A%20%20%20%20%3Flink%20hctl%3AhasTarget%20%3FrelatedTD%20.%0A%20%20%20%20BIND(URI(%3FrelatedTD)%20AS%20%3FprojectTD)%20.%0A%20%20%20%20%3FprojectTD%20td%3AhasPropertyAffordance%20%3FprojProp%20.%0A%20%20%20%20%3FprojProp%20td%3Aname%20%22platform%3AhasIRI%22%20.%0A%20%20%20%20%3FprojProp%20td%3AhasForm%20%3FprojForm%20.%0A%20%20%20%20%3FprojForm%20hctl%3AhasTarget%20%3FiriHref%20.%0A%20%20%20%20BIND(%3Chttps%3A%2F%2Fdata.cogito.iot.linkeddata.es%2Ftdd%2Fapi%2Fthings%2Fb3fe643d-f9f2-4e14-bf3c-95343d63c850%3E%20AS%20%3FbindProjTD)%20.%0A%20%20%20%20BIND(CONCAT(STR(%3Ftarget2)%2C%20%22%20-%20%22%2C%20%3Ftype)%20AS%20%3Ffile).%0A%20%20%20%20FILTER(%3FprojectTD%20%3D%20%3FbindProjTD)%0A%7D%20GROUP%20BY%20%3Ftd%20%3Ftitle%20%3Fdescription%20%3Ftarget%20%3FrelatedTD%20%3FiriHref%0A"

var elements_url = "https://data.cogito.iot.linkeddata.es/tdd/api/search/sparql?query=" + elements_query;
    ...
    request.onload = function () {
        if (request.status === 200) {
            ...
            for (var i = 0; i < results.length; i++) {
                ...
                $("#eventList").append(createListElementForEvent(i, "Project"));
                // alert(td_url)
...
$(document).ready(function () {
    var request = new XMLHttpRequest();
    request.open("POST", elements_url);
    request.onload = function () {
        if (request.status === 200) {
            events = JSON.parse(request.responseText);
            head = events.head;
            ...
            for (var i = 0; i < results.length; i++) {
                // console.log(results[i]);
                $("#eventList2").append(createListElementForEvent(i, "Element"));
                // render_td(td_url, class_id);
            }
            if (events.length > 0) {
                console.log("refreshing table");
